    ...
    <table border="1" class="table table-bordered table-hover">
        ...
        <c:forEach items="${contacts}" var="contact">
            <tr>
                ...
                <td>${contact.email}</td>
                <td>
                    <a class="btn btn-default btn-sm" href="update?id=${contact.id}">修改</a>
        ...
        <tr>
            <td colspan="8" align="center" class="form-inline">
                <c:forEach begin="${begin}" end="${end}" var="idx">
                        <a  class="btn btn-default ${idx == currentPage? 'btn-success':''} " href="query_contact_page?currentPage=${idx}&pageSize=${pageSize}">${idx}</a>
                </c:forEach>
